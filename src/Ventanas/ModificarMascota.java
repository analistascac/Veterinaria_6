...
public class ModificarMascota extends JFrame {
	...
	public ModificarMascota() {
		...
		cmbId.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				txtNombreCientifico.setText(mas.getNombre_cientifico());
				txtNombreVulgar.setText(mas.getNombre_vulgar());
				duenos.setSelectedItem(duenos.getElementAt(duenos.getIndexOf(mas.getDueno())));
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				mas.setIdentificador((String)cmbId.getSelectedItem());
				...
				JOptionPane.showMessageDialog(null, mas.toString(),"Informacion",JOptionPane.INFORMATION_MESSAGE);
			}
		});
	...
	private Mascota obtenerMascota(){
		...
		mas.setDueno("Dueño prueba 1");
		mas.setIdentificador("Identificador 1");
		mas.setNombre_cientifico("Nombre cientifico de pruebas");
		mas.setNombre_vulgar("Nombre vulgar de pruebas");
		return mas;
	}
