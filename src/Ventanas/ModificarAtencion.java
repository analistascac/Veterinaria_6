...
public class ModificarAtencion extends JFrame {
	...
	public ModificarAtencion() {
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				atencion.setCliente((String) cmbCliente.getSelectedItem());
				atencion.setMascota((String)cmbMascota.getSelectedItem());
				atencion.setTipo_consulta((String)cmdTipoConsulta.getSelectedItem());
		...
		cmbId.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//PASARLE LA ID SELECCIONADA A LOS DATOS Y QUE ESTE ME DEVUELVA UN OBJETO CON LO QUE HACE FALTA PARA LLENAR LOS TEXT.
	...
	private void llenarVeterinarios(){veterinario.addElement("Veterinario prueba");}
	private void llenarMascotas(){mascota.addElement("Mascota prueba");}
	private void llenarClientes(){clientes.addElement("Cliente prueba");}
