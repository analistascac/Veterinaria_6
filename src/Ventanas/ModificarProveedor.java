			...
			public void actionPerformed(ActionEvent arg0) {
				if (!txtCuit.getText().trim().isEmpty() &&
						...
						!txtEmail.getText().trim().isEmpty()){
							...
							prov.setRazon_social(txtRazonSOcial.getText());
							...
							prov.setIdentificador(cmbId.getSelectedItem()+"");
							
							JOptionPane.showMessageDialog(null, prov.toString(),"Información",JOptionPane.INFORMATION_MESSAGE);
